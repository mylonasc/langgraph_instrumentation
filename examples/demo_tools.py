...
class DemoAgentToolsFacade:
    ...
    def get_weather(city: str) -> str:
        ...
        return (
            f"The weather in {city} is {random.choice(conditions)} with a temperature of {temp}°C."
        )
    ...
    def get_tools(self) -> list[BaseTool]:
        ...
        """
        return [self.get_weather, self.complex_calculation, self.reverse_text, self.sum_numbers]
